...
public class AggregateObservations extends OneShotBehaviour {
	...
	private Runnable receiveStrategy;
	private Runnable sendStrategy;
	
	public AggregateObservations(AbstractMultiAgent myagent, String treeId, Mode mode, int treshold) {
		super(myagent);
	...
	public void sendParent()
	{
		...
		msg.setProtocol("PUSHSUM-ANSWER-PARENT");
	...
	{
		MessageTemplate pattern = MessageTemplate.and(MessageTemplate.MatchProtocol("PUSHSUM-REQUEST-CHILD"), MessageTemplate.MatchPerformative(ACLMessage.REQUEST));
	...
	public void checkChildrenResponse() {
		...
		for (AID child: this._myAgent.getTree(treeId).getChildren()) 
		{
			...
			MessageTemplate pattern = MessageTemplate.and(MessageTemplate.MatchProtocol("PUSHSUM-ANSWER-PARENT"), MessageTemplate.MatchPerformative(ACLMessage.INFORM));
			pattern = MessageTemplate.and(pattern, MessageTemplate.MatchConversationId(this.treeId));
	...
	public void request_child(AID child)
	{
		...
		msg.setProtocol("PUSHSUM-REQUEST-CHILD");
		msg.setConversationId(this.treeId);
