...
public class ExploreMultiFSMBehaviour extends FSMBehaviour 
{
	...
	public ExploreMultiFSMBehaviour(ExploreMultiAgent myagent) {
		...
		this.registerTransition("RESET-KNOWLEDGE", "EXPLORE-BROADCAST", FSMCodes.Events.SUCESS.ordinal());
		...
		this.registerTransition("RANDOM-WALK", "EXPLORE-BROADCAST", FSMCodes.Events.SUCESS.ordinal());
		this.registerTransition("RANDOM-WALK", "EXPLORE-BROADCAST", FSMCodes.Events.FAILURE.ordinal());
	}
